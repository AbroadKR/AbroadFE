        ...
        <MainBox className="detail_mainBox" top={rectValue} isOpen={isOpen}>
            <LeftBox className="detail_leftBox">
                ...
                <LeftCaption className="rightBox_caption">
                    ...
                    <span className="caption_avg_point">{(evaluations.avgPoint/reviews.length).toFixed(1)}</span>
                </LeftCaption>
                        ...
                        <li key={index}>
                            <CommentContent className="comments_info">
                                <span className="comments_empty_point">
                                    <span style={{minWidth : `${(review.avg_point/5)*100}%`}} className="comments_filled_point"></span>
                                </span>
                                <div className="comments_id">{review.user_id}</div>
                            </CommentContent>
                            <CommentText className="comments_comments">{review.comment}</CommentText>
                        </li>
                    ))}
                </Comments>
