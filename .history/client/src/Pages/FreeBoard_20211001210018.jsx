    ...
    return (
        <>
            ...
            <TableBox>
                ...
                <PageBox>
                    <Pagination currentPage={currentPage} handlePage={handlePage} setCurrentPage={setCurrentPage} firstIndex={firstIndex} lastIndex={lastIndex} pageCount={pageCount}/>
                    <WriteBtn>글 작성</WriteBtn>
                </PageBox>
                <SearchBottom setPosts={setPosts} params={match.params}/>
            </TableBox>
        </>
    )
}
