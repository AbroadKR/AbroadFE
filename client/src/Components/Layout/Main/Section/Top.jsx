            ...
            <SearchBar>
                <Container tabIndex="1" className="container" onClick={()=>togglePopup("koUniv")} onBlur={()=>setClickedOptions("")}>
                    <Options className="koUniv">
                        ...
                        <KoUnivInput className="koUnivInput" type="text" name="koUniv" placeholder="현재 재학 중인 대학을 입력하세요"
                            autoComplete="off" onChange={koUnivMatches} onKeyUp={koUnivMatches} ref={koUnivInputRef}/>
                    </Options>
                {clickedOptions === "koUniv" ? <KoUnivPopup koUnivLists={koUnivLists} handleInput={handleInput}/> : ""}
                </Container>
                ...
                <Container tabIndex="1" className="continent" onClick={()=>togglePopup("continent")} onBlur={()=>setClickedOptions("")}>
                    <Options className="continent">
                        ...
                        <NormalInput type="text" name="continent" placeholder="어느 대륙을 선호하시나요?" className="continentInput" ref={continentInputRef} disabled/>
                    </Options>
                    {clickedOptions === "continent" ? <ContinentPopup continents={continents} handleContinent={handleContinent}/> : ""}
                </Container>
                <Bar className="bar"></Bar>
